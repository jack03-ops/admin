...
export default function Header({ title, user, setPage }) {
  return (
    <header className="h-20 border-b border-orange-500/10 bg-[#060814]/70 backdrop-blur-md px-6 md:px-8 flex items-center justify-between sticky top-0 z-30">
      {/* Title / Greetings */}
      <div>
        <h2 className="text-base md:text-xl font-bold text-white tracking-tight flex items-center gap-2">
          <Dumbbell className="w-4 h-4 md:w-5 md:h-5 text-orange-500 shrink-0" />
