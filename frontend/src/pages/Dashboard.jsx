...
export default function Dashboard({ members, payments, setPage }) {
  ...
  return (
    <div className="p-8 space-y-8 overflow-y-auto max-h-[calc(100vh-80px)]">
      {/* Welcome Banner */}
      <div className="flex justify-between items-center bg-gradient-to-r from-zinc-900 to-zinc-950 p-8 rounded-3xl border border-zinc-900 shadow-xl relative overflow-hidden">
        ...
        <button 
          ...
          className="px-5 py-3 bg-gradient-to-r from-red-600 to-rose-500 hover:from-red-500 hover:to-rose-400 text-white text-sm font-semibold rounded-xl transition-all shadow-md flex items-center gap-2 cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="glass-panel p-6 rounded-2xl border border-zinc-900 lg:col-span-2">
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="text-xs font-semibold text-red-400 bg-red-500/10 px-3 py-1 rounded-full flex items-center gap-1">
